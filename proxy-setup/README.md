...
|--------|----------|----------|
| **8080** | **Smart Proxy + Web UI** | Tu punto de entrada. Auto-limpia sesiones al cambiar canal |
| 6878 | AceStream Engine | Motor P2P (lo usa el proxy internamente) |
| 8888 | HTTPAceProxy | Listas IPTV, estadísticas |

Cuando cambias de canal en VLC, el smart proxy para la sesión anterior automáticamente via la API del engine. Sin bloqueos.
...
acestream-ctl lists       # Listas IPTV
...
**Timeout sesiones**: `SESSION_TIMEOUT=600` (smart proxy, en segundos)
...
iPhone / PC (VLC)
 ...
 │                                     │
 │  :8080  Smart Proxy + Web UI        │ ← Pegas la URL aquí
 │              │                      │
 │              ▼                      │
